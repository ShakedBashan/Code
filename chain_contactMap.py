...
"""Map differences between C and F"""
map_only(dicC, dicF)
map_only(dicF, dicC)
"""Map common contacts that changed > 20% between C and F"""
changedCF = map_changed_contacts(dicC, dicF)
print('Contacts changed >= 20%:\n', changedCF)
print(changedCF)

"""Map common contacts between C and F"""
# map_commons(dicC, dicF)

#%% Unique contacts in each chain (that are not in F)

"""Create maps that can be shown together (NOT IN F)"""
only_chainA = {(k): [dicA[k]] for k in dicA if k not in dicF}
# print(only_chainA)
print('Chain A unique contacts:(not in F)', len(only_chainA))
...
# print(only_chainB)
print('Chain B unique contacts:(not in F)', len(only_chainB))
...
# print(only_chainC)
print('Chain C unique contacts:(not in F)', len(only_chainC))
...
# print(only_chainD)
print('Chain D unique contacts:(not in F)', len(only_chainD))
...
# print(only_chainE)
print('Chain E unique contacts:(not in F)', len(only_chainE))
...
# print(only_chainF)
print('Chain F unique contacts:(not in C)', len(only_chainF))
